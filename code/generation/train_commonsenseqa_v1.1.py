...
class CommonsenseExample:
    ...
    def __init__(self, question, choice0, choice1, choice2, choice3, choice4, answer_text, explanation, explain_predict=True):
        if explain_predict:
            self.text = f'{question} The choices are {choice0}, {choice1}, {choice2}, {choice3}, or {choice4}. My commonsense tells me '
        else:
            self.text = f'{question} The choices are {choice0}, {choice1}, {choice2}, {choice3}, or {choice4}. The answer is {answer_text} because '
    ...
    def from_list(cls, o, train=True, explain_predict=True):
        ...
        q, c0, c1, c2, c3, c4 = o[1:7]
        if train:
            ak = o[7]
            ex = o[8]
            at = [c0, c1, c2, c3, c4][int(ak)]
        return CommonsenseExample(q, c0, c1, c2, c3, c4, at, ex, explain_predict=explain_predict)
    ...
    def tokenize(self, tokenizer):
        ...
        self.choice3 = tokenizer.tokenize(self.choice3)
        self.choice4 = tokenizer.tokenize(self.choice4)
    ...
    def numericalize(self, tokenizer):
        ...
        self.choice3 = tokenizer.convert_tokens_to_ids(self.choice3)
        self.choice4 = tokenizer.convert_tokens_to_ids(self.choice4)
        if self.explanation is not None:
...
#        path = os.path.join(root_path, f'{split}-noexpl-pred.csv') 
...
def run_model():
    ...
    parser.add_argument("--do_eval_train", action='store_true', help="Whether to run eval on the test set.")
